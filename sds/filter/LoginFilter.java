...
public class LoginFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain filterChain) throws IOException, ServletException {
        ...
        if (session == null) { //没有登录
            ...
            if ("/public/page/main.html".equals(uri)) {
                ...
                return;
                    ...
                    //
                req.setCharacterEncoding("UTF-8");//请求数据的编码格式
                res.setCharacterEncoding("UTF-8");//设置相应数据的编码格式
                res.setContentType("appliction/json");//设置响应数据格式
        ...
        filterChain.doFilter(request,response);//过滤器向下调用继续过滤
